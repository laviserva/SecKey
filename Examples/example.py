...
"""
ch.add_data_to_file(["//ssite4", "//uuser4", "//ppass4"], file_encripted) 
ch.add_data_to_file(["//ssite1", "//uuser5", "//ppass5", "ignored"], file_encripted)
...
decripted_text = ch.load_and_decript_file(file_encripted) # Ok uses the previous one key. (new_key, if it was uncommented)
